...
export type PluginExtractedValue<P extends PluginParam = PluginParam> = PluginStringValue<P> | PluginNumberValue<P> | PluginBooleanValue;
/**
 * @deprecated Use `PluginValuesS`, `PluginValuesN`, or `PluginValuesB` instead, depending on the expected value type.
 */
export type PluginValues<P extends PluginParam = PluginParam> = PluginExtractedValue<P>;
/**
 * @deprecated Use `PluginValuesS` instead, which is specifically designed for string values and provides clearer semantics.
 */
export type PluginValuesS<P extends PluginParam = PluginParam> = PluginStringValue<P>;
 ...
 */
export type PluginValuesN<P extends PluginParam = PluginParam> = PluginNumberValue<P>;
