...
export declare const createPluginCommandExtractorMap: (schema: PluginMinimumSchema, factoryFn: (path: string) => JSONPathReader) => Map<CommandMapKey, CommandArgExtractors>;
