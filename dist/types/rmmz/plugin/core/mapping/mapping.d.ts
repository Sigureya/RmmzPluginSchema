...
export declare const compileScalarAttributes: <Kind extends string, T>(kind: Kind, defaultValue: T, tokens: Record<string, string>, fnTable: TableConcept) => {
    kind: Kind;
    default: T;
} & { [K in keyof TableConcept]?: ReturnType<TableConcept[K]>; };
export declare const compileArrayAttributes: <T extends TableConcept & {
