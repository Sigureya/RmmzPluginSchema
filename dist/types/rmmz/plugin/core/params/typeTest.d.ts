import { PrimitiveParam, ArrayParam, ParamKinds, ScalarParam, StructRefParam, PluginParam, PluginParamEx, StructArrayRefParam, PrimitiveStringParam, StringArrayParam, ArrayParamTypes, RpgVariableParam, RpgVariableArrayParam, FileParam, FileArrayParam, PrimitiveTextParam } from './types';
...
export declare const isScalarParam: <T extends PrimitiveParam>(param: T) => param is Extract<T, ScalarParam>;
...
export declare const hasScalarAttr: (param: PluginParam) => param is PluginParamEx<ScalarParam>;
...
export declare const isStringValueParam: (param: ScalarParam) => param is Extract<PrimitiveParam, {
    default: string;
}>;
export declare const isNumberValueParam: (param: PrimitiveParam) => param is Extract<PrimitiveParam, {
    default: number;
}>;
export declare const isNumberValueParamEx: (param: ScalarParam) => param is Extract<PrimitiveParam, {
    default: number;
}>;
