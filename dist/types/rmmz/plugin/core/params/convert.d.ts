import { PluginCommandSchemaArrayFiltered, PluginCommandTypeEx, PluginParam, PluginParamEx, PluginStructSchemaArray, PluginStructType, PrimitiveParam, ObjectParamsV5, ScalarParam } from './types';
export declare function toObjectPluginParamsOld(params: ReadonlyArray<PluginParam>): Record<string, PrimitiveParam>;
export declare function toObjectPluginParams<S extends ScalarParam>(params: ReadonlyArray<PluginParamEx<S>>): Record<string, S>;
