...
export interface SourceId_Data<Kind extends string> extends SourceIdentifier {
    author: "rmmz";
    module: "data";
    kind: Kind;
}
...
export type SourceIdUnion_RpgData = SourceId_DataActor | SourceId_DataArmor | SourceId_DataClass | SourceId_DataEnemy | SourceId_DataItem | SourceId_DataSkill | SourceId_DataState | SourceId_DataWeapon | SourceId_DataCommonEvent | SourceId_DataTroop;
