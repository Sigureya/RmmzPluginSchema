...
import type { StructPathNode, StructPathNodeListWithErrors } from "./template";
...
export interface PluginValuesPath extends PluginValuesPathBase {
  ...
  structs: StructPathNodeListWithErrors<
    PluginScalarParam,
    PluginArrayParamType
  >;
  structArrays: StructPathNodeListWithErrors<
    PluginScalarParam,
    PluginArrayParamType
  >;
}
...
export interface PrimitivePluginValuesPath<
