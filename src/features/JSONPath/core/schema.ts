...
export const createPluginCommandExtractor = (
  schema: PluginCommandMinimumSchemaOld,
  factoryFn: (path: string) => JSONPathReader,
): CommandExtractorEntry[] => {
